...
class vgg19(nn.Module):
    ...
    def __init__(self, pretrained_path = '/home/xteam1/2022/HFFNE/refine/data/vgg19-dcbb9e9d.pth', require_grad = False):
...
class vgg19_class_fea(nn.Module):
    ...
    def __init__(self, pretrained_path = '/home/toughlife/WM/myCode/Color2Embed-main/data/vgg19-dcbb9e9d.pth', require_grad = False):
